...
image:
  path: /assets/img/posts/hitl-guardrails-guide/hero.png
...
- [NeuroLink vs LangChain](/posts/neurolink-vs-langchain/) - Compare NeuroLink to other SDKs
...
For the complete API reference, see the [NeuroLink HITL Documentation](https://docs.neurolink.ink/features/hitl/). For source code and contributions, visit [github.com/juspay/neurolink](https://github.com/juspay/neurolink).
