...
tags:
  ...
  - extensibility
author: neurolink
description: "Integrate MCP tools with NeuroLink. Connect AI to databases, APIs, and external services."
toc: true
mermaid: true
pin: false
---

# MCP Tools: Extending AI with External Capabilities

Large language models excel at reasoning and text generation. But they cannot check your database, call your APIs, or interact with external services on their own. The Model Context Protocol (MCP) bridges this gap by providing a standardized way to give AI models access to external tools and capabilities.

NeuroLink integrates MCP tools directly into its generation pipeline. Your AI can query databases, fetch real-time data, execute code, and interact with any service you expose through MCP. This transforms AI from a passive text generator into an active agent that accomplishes real work.

This tutorial covers everything you need to integrate MCP tools with NeuroLink. You will understand the protocol architecture, define custom tools, handle security considerations, and build production-ready integrations. By the end, your AI applications will have access to the entire capability landscape of your infrastructure.
...
// StreamChunk types: { type: "text"; content: string } or { type: "audio"; audioChunk: TTSChunk }
...
- [Streaming Responses](/posts/streaming-responses/) - Real-time AI output
- [Multi-Provider Architecture](/posts/multi-provider/) - Use multiple LLM providers
- [Guardrails and Safety](/posts/guardrails-safety/) - Implement AI safety controls
- [Production Deployment](/posts/production-deployment/) - Scale your AI applications
